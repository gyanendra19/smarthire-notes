    ...
    return (
        <>
            ...
            <form className='flex flex-col gap-4 w-full' onSubmit={addNote}>
                <input onChange={(e) => setTitle(e.target.value)} value={title} placeholder='Title' className='h-[50px] focus:outline-none p-3 bg-[#F9F9F9] rounded-xl w-3/4 mx-auto' type="text" />
